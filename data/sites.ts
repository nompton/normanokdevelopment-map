...
export const SITES: DevelopmentSite[] = [
  ...
  },
  {
    ...
    address: "N Norman, OK",
    lat: 35.26506157344967,
    lng: -97.49061801938468,
    status: "under-construction",
    description: "VA clinic under construction in North Norman.",
    articles: [],
    planPdf: undefined,
  },
  {
    id: "oklahoma-aviation-academy",
    name: "Oklahoma Aviation Academy",
    address: "Norman, OK",
    lat: 35.24187765731196,
    lng: -97.46432238136516,
    status: "under-construction",
    description: "Oklahoma Aviation Academy, a Norman Public Schools program, under construction.",
    articles: [
      {
        title: "Oklahoma Aviation Academy — Norman Public Schools",
        url: "https://www.normanpublicschools.org/o/aviation",
        date: "",
      },
    ],
    planPdf: undefined,
